...
class AdminService:
    ...
    def update_system_config(
        ...
        allowed_keys = [
            ...
            "beans_checkin_base",
            "beans_checkin_early_bird",
            "beans_checkin_early_bird_end_time",
            "beans_resource_download_base",
            "beans_resource_download_expert_discount",
            "beans_resource_upload_income_ratio",
            "beans_resource_download_income_ratio",
            "beans_reputation_deduct_restore_ratio",
            "beans_reputation_deduct_to_beans_ratio",
            "beans_pack_1_capacity",
            "beans_pack_1_price",
            "beans_pack_2_capacity",
            "beans_pack_2_price",
            "beans_pack_3_capacity",
            "beans_pack_3_price",
            "beans_pack_4_capacity",
            "beans_pack_4_price",
            "beans_pack_5_capacity",
            "beans_pack_5_price",
